const EDITIONS = [
  {
    ...
    boardSpaces: [
      ...
      { id: "long-thanh-dong-nai-airport", space: 38, name: "Long Thành Đồng Nai", type: "transport" },
    ...
    properties: [
      ...
      { id: "long-thanh-dong-nai-airport", name: "San Bay Long Thành Đồng Nai", type: "transport", category: "transport", colourGroup: "transport", canBuild: false },
